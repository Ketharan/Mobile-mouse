...
/**
 * Created by Haran on 02/01/2018.
 */
...
public class BluetoothMonitor extends AppCompatActivity{
    ...
    protected ConnectedThread mConnectedThread; // bluetooth background worker thread to send and receive data
    protected BluetoothSocket mBTSocket = null; // bi-directional client-to-client data path

    protected static final UUID BTMODULEUUID = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"); // "random" unique identifier
    ...
    private BluetoothMonitor(Context context, Activity activity){
    ...
    public static BluetoothMonitor getBluetoothMonitor(Context context, Activity activity){

        if (bluetoothMonitor == null){
            bluetoothMonitor = new BluetoothMonitor(context,activity);
        }
        return bluetoothMonitor;
    }

    public static BluetoothMonitor getBluetoothMonitor(){
    ...
    protected void bluetoothOn(View view){
    ...
    protected void bluetoothOff(View view){
    ...
    protected void listPairedDevices(View view){
    ...
    protected AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            Toast.makeText(context.getApplicationContext(), "I am clicked", Toast.LENGTH_SHORT).show();
            if(!mBTAdapter.isEnabled()) {
                Toast.makeText(context.getApplicationContext(), "Bluetooth not on", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            {
                public void run() {
                //    Toast.makeText(context.getApplicationContext(), "inside run", Toast.LENGTH_SHORT).show();
                    boolean fail = false;
